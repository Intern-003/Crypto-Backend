...
class GlidePayInController extends Controller
{
    ...
    private function createGlideWidgetSession($params)
    {
        ...
        // dump($metaTokenHash);
        $metaToken = is_array($metaTokenHash)    ? ($metaTokenHash['encrypted'] ?? null)   : $metaTokenHash;
    ...
    private function generateGlidePayOrder($requestParams, $user_id)
    {
        ...
        $remainingAmount = $this->numberFormat($remainingAmount);
